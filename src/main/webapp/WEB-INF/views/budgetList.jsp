...
<body>
												...
												<c:forEach items="${budgetList}" var="budget"
													...
													<tr>
														...
														<td class="text-center">
															...
															<a class="btn btn-danger custom" onclick="deleteBudget(${budget.id});" href="#">Delete</a>
														</td>
													</tr>
												</c:forEach>
	...
	<script type="text/javascript">
		function deleteBudget(budgetId){
			...
			w2confirm('Do you want to Delete this Budget?', function btn(answer) {
			    if(answer == 'Yes'){
			    	window.location.href = contextPath+"/deleteBudget?id="+budgetId;
			    } 
			});
		}
	</script>
