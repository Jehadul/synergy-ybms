...
<body>
												...
												<c:forEach items="${budgetSourceList}" var="budgetSource" varStatus="slNo">
													<tr>
														...
														<td class="text-center">
															...
															<a class="btn btn-danger custom" onclick="deleteBudgetSource(${budgetSource.id});" href="#">Delete</a>
														</td>
													</tr>
												</c:forEach>
	...
	<script>
		function deleteBudgetSource(budgetSourceId){
			var contextPath = $('#contextPath').val();	
			
			w2confirm('Do you want to Delete this Budget Source?', function btn(answer) {
			    if(answer == 'Yes'){
			    	window.location.href = contextPath+"/deleteBudgetSource?id="+budgetSourceId;
			    } 
			});
		}
