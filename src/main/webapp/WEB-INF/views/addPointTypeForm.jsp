...
<body>
												...
												<c:forEach items="${pointTypeList}" var="pointType" varStatus="slNo">
													<tr>
														...
														<td class="text-center">
															...
															<a class="btn btn-danger custom" onclick="deletePointType(${pointType.id});" href="#">Delete</a>
														</td>
													</tr>
												</c:forEach>
	...
	<script>
		function deletePointType(pointTypeId){
			var contextPath = $('#contextPath').val();	
			
			w2confirm('Do you want to Delete this Point Type?', function btn(answer) {
			    if(answer == 'Yes'){
			    	window.location.href = contextPath+"/deletePointType?id="+pointTypeId;
			    } 
			});
		}
