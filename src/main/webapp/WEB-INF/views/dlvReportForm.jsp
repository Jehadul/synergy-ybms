...
<body>
	<!-- Page heading start -->
	<div class="page-head">
		<h2 class="pull-left" style="color: #428bca;">Dlv Reports Form</h2>
					...
					<div class="widget-content">
						<div class="padd">
							...
							<form:form cssClass="form-horizontal" method="GET" name="reg"
								...
								action="${pageContext.request.contextPath}/downLoadDlvReport">

								<div class="form-group">
									<label class="col-lg-2 control-label">Fiscal Year <span
										class="red">*</span>:
									</label>
									<div class="col-lg-5">
										<form:select path="fiscalYearId" id="fiscalYearId"
								...
								<div class="form-group">
								<label class="radio-inline">Version <span
										class="red">*</span>:
										
									</label>
									<label class="radio-inline"> <input type="radio"
											name="version" value="ban" checked>Bangla
										</label> <label class="radio-inline"> <input type="radio"
											name="version" value="eng">English
										</label> 
