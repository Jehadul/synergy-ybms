...
<body>
												...
												<c:forEach items="${goodsTypeList}" var="goodsType" varStatus="slNo">
													<tr>
														...
														<td class="text-center">
															...
															<a class="btn btn-danger custom" onclick="deleteGoodsType(${goodsType.id});" href="#">Delete</a>
														</td>
													</tr>
												</c:forEach>
	...
	<script>
		function deleteGoodsType(goodsTypeId){
			...
			w2confirm('Do you want to Delete this Goods Type?', function btn(answer) {
			    if(answer == 'Yes'){
			    	window.location.href = contextPath+"/deleteGoodsType?id="+goodsTypeId;
			    } 
			});
		}
